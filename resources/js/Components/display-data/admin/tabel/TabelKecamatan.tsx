            ...
            <thead>
                <tr>
                    <th className="border-b text-left w-4 py-1 px-2">
                        <input type="checkbox" className="w-3 h-3 text-blue-500 bg-gray-100 border-gray-300 rounded focus:ring-transparent" checked={selectAllTableRows.kecamatan} onChange={() => handleSelectAllChange(selectAllTableRows, dataKecamatan, setSelectedRows, setSelectAllTableRows, 'kecamatan')} />
                    </th>
